...
metObjectsJSON = os.path.join(dir, 'assets','metObjects.json')
...
## Export JSONs ##
aggYear.to_json(os.path.join(dir, 'assets','aggYear.json'))
aggCountry.to_json(os.path.join(dir, 'assets','aggCountry.json'))
aggCountryClassification.to_json(os.path.join(dir, 'assets','aggCountryClassification.json'))
aggYearCountry.to_json(os.path.join(dir, 'assets','aggYearCountry.json'))
aggYearCountryOther.to_json(os.path.join(dir, 'assets','aggYearCountryOther.json'))
aggCountryClassificationOther.to_json(os.path.join(dir, 'assets','aggCountryClassificationOther.json'))
aggYearClassification.to_json(os.path.join(dir, 'assets','aggYearClassification.json'))
aggYearClassificationOther.to_json(os.path.join(dir, 'assets','aggYearClassificationOther.json'))
aggYearCountryClassification.to_json(os.path.join(dir, 'assets','aggYearCountryClassification.json'))
aggYearCountryClassificationOther.to_json(os.path.join(dir, 'assets','aggYearCountryClassificationOther.json'))
